<?php
    ...
    $email_to = "tequedlabsjobportal@info.com";
...
<title>Tequed Labs Job Portal-Job Directory</title>
...
<div id="wrapper"> 
  ...
  <header id="header"> 
    ...
    <div class="cp-burger-nav"> 
      ...
      <div id="cp_side-menu"> <a href="#" id="cp-close-btn" class="crose"><i class="fa fa-close"></i></a>
        ...
        <strong class="copy">Tequed Labs &copy; 2023, All Rights Reserved</strong> </div>
  ...
  <!--INNER BANNER END-->
    ...
    <div class="container">
      ...
      <div class="bottom-row"> <strong class="copyrights">Tequed Labs Job Portal &copy; 2023, All Rights Reserved, Design &amp; Developed By: <a href="http://crunchpress.com/" target="_blank">CrunchPress</a></strong>
