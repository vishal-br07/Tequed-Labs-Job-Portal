        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-8">
            ...
            <div class="resumes-content">
              <h2>Showing Resumes of New Candidates</h2>
...
$eid=$_SESSION['emplogin'];
  ...
  $next_page = $page_no + 1;
  $adjacents = "2"; 
$ret = "SELECT tbljobs.jobId FROM tblapplyjob join tbljobs on tblapplyjob.JobId=tbljobs.jobId join tbljobseekers  on tblapplyjob.UserId=tbljobseekers.id where tbljobs.employerId=:eid and (tblapplyjob.Status='' || tblapplyjob.Status is null)";
