...
else
{
  echo $pstatus=$row->Status;
     ...
     ;?></a>  </div>
                  ...
                  <div class="btn-row"> 
                    <a href="../Jobseekersresumes/<?php echo htmlentities($row->Resume);?>" class="resume" target="_blank"><i class="fa fa-file-text-o"></i>Resume</a> 
                    <a href="candidates-details.php?canid=<?php echo ($row->id);?>" class="contact" target="_blank">View Candidate Detail</a> <a href="app-details.php?jobid=<?php echo ($row->JobId);?> && name=<?php echo htmlentities ($row->FullName);?>" class="login" target="_blank">Application Details</a></div>
...
<h4 align="center" style="color:purple">No record found against this search</h4>
