...
foreach($results as $result)
{
 ...
 <img src="../images/<?php echo $row->ProfilePic;?>" width="100" height="100" >
     ...
     <div class="text-box">
                  ...
                  <div class="btn-row"> 
                    <a href="../Jobseekersresumes/<?php echo htmlentities($result->Resume);?>" class="resume" target="_blank">
                      <i class="fa fa-file-text-o"></i>Resume</a></div>
 ...
 ?>
                <div class="outer"> <strong class="title"><?php echo htmlentities($result->Qualification);?></strong>
                  ...
                  <div class="col"> <span><?php echo htmlentities($result->PassingYear);?></span>
                    ...
                    <p><strong style="color: purple">College/ School Name</strong>: <?php echo htmlentities($result->ClgorschName);?></p>
                    <p><strong style="color: purple">Stream</strong>: <?php echo htmlentities($result->Stream);?></p>
                    <p><strong style="color: purple">CGPA</strong>: <?php echo htmlentities($result->CGPA);?></p>
                    <p><strong style="color: purple">Percentage</strong>: <?php echo htmlentities($result->Percentage);?></p>
                  </div>
 ...
 ?>
                <div class="outer"> <strong class="title"><?php echo htmlentities($result->Designation);?> at <b>(<?php echo htmlentities($result->EmployerName);?>)</b></strong>
                  ...
                  <div class="col"> <span><?php echo htmlentities($result->FromDate);?> - <?php echo htmlentities($result->ToDate);?></span>
                   ...
                   <p><strong style="color: purple">Type of Employment: </strong>: <?php echo htmlentities($result->EmployementType);?></p>
                   <p><strong style="color: purple">CTC: </strong>: <?php echo htmlentities($result->Ctc);?>(per month)</p>
                    <p><strong style="color: purple">Skills: </strong>: <?php echo htmlentities($result->Skills);?></p>
